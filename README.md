...
- **ResultPerformer** — выводит результаты разложения с метриками производительности
...
- Использование `std::jthread` с автоматическим присоединением
...
- UDP сокеты с таймаутом для неблокирующего чтения
